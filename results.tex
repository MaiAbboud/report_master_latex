...
%\section{مجموعات معطيات تدريب أخرى}
...
%	\caption{\textRL{تابع خطأ شبكة التصنيف أثناء التدريب}}
%	\endminipage\hfill
%	\minipage{0.49\textwidth}
%	\includegraphics[width=\linewidth]{charts/Section-2-Panel-13-ffs6mrffa}
%	
%	\caption{regression
%		\textRL{تابع خطأ شبكة ال}}
%	\endminipage\hfill
%\end{figure}
...
%	\caption{\textRL{تابع الخطأ الكلي أثناء التدريب}}
%	\endminipage\hfill
%\end{figure}
%\selectlanguage{arabic}
نلاحظ هبوط منحنيات وسطي الخطأ أثناء التدريب.
...
%\caption{val
%	\textRL{خطأ شبكة التصنيف على مجموعة}}
%	\endminipage\hfill
%	\minipage{0.49\textwidth}
...
%	\caption{val
%		\textRL{تابع الخطأ الكلي على مجموعة}}
%	\endminipage\hfill
%\end{figure}
%\selectlanguage{arabic}
\begin{figure}[H]
